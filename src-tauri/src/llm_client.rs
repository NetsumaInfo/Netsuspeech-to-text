...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/NetsumaInfo/Netsuspeech-to-text"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("Netsuspeech/1.0 (+https://github.com/NetsumaInfo/Netsuspeech-to-text)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("Netsuspeech"));
